...
export const SAUDI_CITIES_AR = [
  'الرياض','جدة','مكة','المدينة المنورة','الدمام','الخبر','الظهران','القطيف','الجبيل',
  'الهفوف','المبرز','الأحساء','الطائف','تبوك','حائل','أبها','خميس مشيط','جازان','نجران',
  'بريدة','عنيزة','الرس','الخرج','المجمعة','سكاكا','عرعر','رفحاء','طريف','رابغ',
  'ينبع','أملج','الوجه','نيوم','الباحة','بلجرشي','القنفذة','الليث',
  'مهد الذهب','بيشة','تربة','وادي الدواسر','الدوادمي','عفيف','الزلفي','البكيرية',
  'البدائع','حوطة بني تميم','شرورة','بقيق','النعيرية','قرية العليا','الخفجي','حفر الباطن',
  'المزاحمية','القويعية','ثادق','ضرما','حريملاء','الحريق','ليلى','تندحة',
  'أحد رفيدة','سراة عبيدة','تنومة','النماص','محايل','بارق','رجال ألمع','فرسان','صبيا'
];